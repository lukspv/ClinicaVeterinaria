 ...
 * @author lucas
 */
public class ServiçosExc extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Excluir Serviço");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServiçosExc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ServiçosExc().setVisible(true);
            }
        });
    }
