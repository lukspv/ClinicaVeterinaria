...
public class ServicosDao {
    ...
    public void Cadastrar(Servicos servicos) throws SQLException{
        
        Conecta=FabricaConexao.Conectar();
        Comando="insert into servico(Servid,Servnome,Servtemp, Servval) values (?,?,?,?)";
        ps=Conecta.prepareStatement(Comando);
       
        ps.setInt(1,servicos.getServid());
        ps.setString(2,servicos.getServnome());
        ps.setDouble(3,servicos.getServval());
        ps.setInt(4,servicos.getServtemp());
