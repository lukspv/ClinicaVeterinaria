...
public class ProdutoDao {
    ...
    public void Cadastrar(Produto produto) throws SQLException{
        ...
        Comando="insert into produto(Prodid,Prodnome,Prodval,Prodqtd, Prodvalor) values (?,?,?,?,?)";
        ps=Conecta.prepareStatement(Comando);
       
        ps.setInt(1,produto.getProid());
        ps.setString(2,produto.getPronome());
        ps.setString(3,produto.getProdval());
        ps.setInt(4,produto.getQtd());
        ps.setDouble(5,produto.getProdvalor());
